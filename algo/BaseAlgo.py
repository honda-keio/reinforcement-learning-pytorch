...
class BaseAlgo:
    def __init__(self, ENV, model, make_env, N, T, VecEnv=SubprocVecEnv, storage_size=int(1e4), v_coef=0.5, ent_coef=0.01, 
                optimizer=partial(torch.optim.RMSprop, eps=1e-5, alpha=0.99, momentum=0.95), ep_len=int(1e3), N_ch=4,
